...
) : position(pos.first, pos.second), velocity(vel.first, vel.second), acceleration(acl.first, acl.second) {}
...
void Hardbody::print() {
    ...
    std::cout << "acl: " << acceleration.x << " " << acceleration.y << std::endl << std::endl;
}
